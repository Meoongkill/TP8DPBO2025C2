    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <div class="d-flex justify-content-between align-items-center">
                <span><i class="fas fa-edit me-2"></i> Form Edit Mahasiswa</span>
        ...
        <div class="card-body">
            ...
            <form action="index.php?controller=Mahasiswa&action=edit&id=<?php echo $mahasiswa['ID_Mahasiswa']; ?>" method="post">
                <div class="mb-3">
