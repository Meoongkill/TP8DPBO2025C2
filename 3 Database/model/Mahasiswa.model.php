...
class Mahasiswa extends DB
{
    ...
    function AddMahasiswa($data)
    {
        ...
        $query = "INSERT INTO mahasiswa (NIM_Mahasiswa, Nama_Mahasiswa, Phone_Mahasiswa) 
        VALUES ('$NIM_Mahasiswa', '$Nama_Mahasiswa', '$Phone_Mahasiswa')";
    ...
    function EditMahasiswa($id, $data)
    {
        ...
        $Nama_Mahasiswa = $data['Nama_Mahasiswa'];
        $Phone_Mahasiswa = $data['Phone_Mahasiswa'];
        $query = "UPDATE mahasiswa SET NIM_Mahasiswa='$NIM_Mahasiswa', Nama_Mahasiswa='$Nama_Mahasiswa', Phone_Mahasiswa='$Phone_Mahasiswa' WHERE id='$id'";
